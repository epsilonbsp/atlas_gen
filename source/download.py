...
def download_file(url: str, path: str|Path, callback: Download_Callback = None) -> tuple[Download_Status, Exception|None]:
    try:
...
def download_file_and_log(name: str, url: str, path: str|Path) -> None:
